...
<br>
<div class="text">
    Le Dhole, ou encore « Chien sauvage d'Asie » (Cuon alpinus) est une espèce de mammifères de la famille des canidés et du genre Cuon, dont il est le seul représentant actuel. Il vit en Asie.
<br>
   ...
   <br> Cet animal évite les territoires où l'être humain est présent et est difficile à observer.
<br>
    <h3> Repartition</h3>
...
<br>
    ...
    <img id="image" src="image/dhole.jpeg" alt="dhole">


    Le Dhole n'est pas le seul canidé présent sur ce territoire de 44,58 millions de km². Vous pouvez vous renseigner sur d'autre canidae présent ci dessous :
    <br>
    <br>
